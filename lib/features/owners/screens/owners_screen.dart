...
class _OwnersScreenState extends State<OwnersScreen> {
  ...
  void _showDeleteConfirmDialog(OwnerModel owner) {
    showDialog(
      context: context,
      builder: (dialogContext) {
        return AlertDialog(
          ...
          title: Text("Delete Owner Profile", style: CRMTypography.sectionTitle),
          content: Text(
            "Are you sure you want to delete ${owner.name}? This will remove their record from the directory.",
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text("Owner Listings Catalog", style: CRMTypography.sectionTitle),
