...
class _BuildersScreenState extends State<BuildersScreen> {
  ...
  void _showDeleteConfirmDialog(BuilderModel builder) {
    showDialog(
      context: context,
      builder: (dialogContext) {
        return AlertDialog(
          ...
          title: Text("Delete Builder Profile", style: CRMTypography.sectionTitle),
          content: Text(
            "Are you sure you want to delete ${builder.companyName}? This will remove their record from active partnerships.",
