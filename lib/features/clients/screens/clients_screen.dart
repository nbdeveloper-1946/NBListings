...
class _ClientsScreenState extends State<ClientsScreen> {
  ...
  void _showDeleteConfirmDialog(ClientModel client) {
    showDialog(
      context: context,
      builder: (dialogContext) {
        return AlertDialog(
          ...
          title: Text("Delete Client Profile", style: CRMTypography.sectionTitle),
          content: Text(
            "Are you sure you want to delete ${client.name}? This will permanently remove their profile.",
            ...
            return isWide
                ...
                : SingleChildScrollView(child: Column(children: stages.map((st) {
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(color: CRMColors.sidebarBg, borderRadius: BorderRadius.circular(CRMBorderRadius.m)),
                      padding: const EdgeInsets.all(CRMSpacing.m),
                      child: ExpansionTile(
                        title: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
