    ...
    final headerBlock = Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [CRMColors.primary.withValues(alpha: 0.8), CRMColors.primary],
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            style: CRMTypography.sectionTitle.copyWith(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 24),
          ),
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            title,
                            style: CRMTypography.bodyMedium.copyWith(fontWeight: FontWeight.bold, fontSize: 16),
                            maxLines: 1,
                        ...
                        Text(
                          price,
                          style: CRMTypography.bodyMedium.copyWith(color: CRMColors.primary, fontWeight: FontWeight.bold, fontSize: 16),
                        ),
                      ],
                    ),
