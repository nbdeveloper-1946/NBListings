                ...
                children: [
                  ChoiceChip(
                    ...
                    labelStyle: TextStyle(
                      color: _selectedTab == 'Properties' ? CRMColors.primary : CRMColors.textOf(context),
                  ...
                  ChoiceChip(
                    ...
                    selectedColor: CRMColors.primary.withValues(alpha: 0.12),
                    labelStyle: TextStyle(
                      color: _selectedTab == 'Requirements' ? CRMColors.primary : CRMColors.textOf(context),
                                    ...
                                    DataCell(
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text(r.clientMobile, style: TextStyle(color: CRMColors.textMuted, fontSize: 11)),
                                        ],
                                      ),
                                    ),
